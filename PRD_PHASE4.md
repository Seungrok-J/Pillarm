...
>
> **진행 상태 (2026-08-21):** Feature 1·2 모두 구현되어 프로덕션에서 운영 중(2026-06-01 최초 배포). Claude Haiku 우선 호출·Sonnet 폴백 구조, 일일 5회 사용 제한(관리자는 무제한), 포(packet) 그룹화, 원터치 확인 UX까지 지속 개선됨.
