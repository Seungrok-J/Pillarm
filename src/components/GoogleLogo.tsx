...
/** Google 공식 브랜드 가이드의 "G" 로고마크(4색) — Sign in with Google 버튼 전용 */
export default function GoogleLogo({ size = 18 }: Props) {
  return (
    <Svg width={size} height={size} viewBox="0 0 18 18">
      ...
      <Path
        fill="#34A853"
        d="M9 18c2.43 0 4.4673-.806 5.9564-2.1805l-2.9087-2.2581c-.8059.54-1.8368.8578-3.0477.8578-2.3436 0-4.3282-1.5831-5.0359-3.7104H.9573v2.3318C2.4382 15.9832 5.4818 18 9 18z"
      />
      <Path
        fill="#FBBC05"
